...
const ObjectivesType = Object.freeze({
    ...
    "Master the Mysticism skill and learn all standard Mysticism spells": {[ConditionType.HAS_SKILL]:[SkillsType.MYSTICISM], [ConditionType.HAS_RACE]:[RacesType.BRETON, RacesType.ARGONIAN, RacesType.DARK_ELF, RacesType.AYLEID, RacesType.CHIMERI_QUEY, RacesType.DUADRI]},
...
const GeographicStipulationsType = Object.freeze({
    ...
    "Start in Gnisis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Urshilaku Camp": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Erabenimsun Camp": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Dagon Fel": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Tel Fyr": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Molag Mar": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Sadrith Mora": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Nivalis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Firewatch": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Port Telvannis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Helnim": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Marog": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Gorne": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Darvonis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Sailen": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Nan Iban": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Bosmora": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Dreynim Spa": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Bisandryon": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Othrenis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Nanaav": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Ald Iuval": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Sadrathim": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Narsis": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Bal Foyen": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Almas Thirr": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Bodrum": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Stormgate Pass": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
    "Start in Septim's Gate Pass": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in","No Seyda Neen"]},
...
const StipulationsType = Object.freeze({
    ...
    "Level 10 cap": {[ConditionType.NOT_HAS_OBJECTIVE]:["Reach Level 20"],[ConditionType.NOT_HAS_STIPULATION]:["Level 15 cap"]},
    "Level 15 cap": {[ConditionType.NOT_HAS_OBJECTIVE]:["Reach Level 20"],[ConditionType.NOT_HAS_STIPULATION]:["Level 10 cap"]},
    ...
    "Can only use gear you bought": {[ConditionType.NOT_HAS_OBJECTIVE]:["Collect"],[ConditionType.NOT_HAS_STIPULATION]:["gear", "Can only use custom enchantments"]},
    "Can only use gear you were given in a quest": {[ConditionType.NOT_HAS_OBJECTIVE]:["Collect"],[ConditionType.NOT_HAS_STIPULATION]:["gear", "Can only use custom enchantments"]},
    "Use Nordic-style gear only": {[ConditionType.HAS_RACE]:[RacesType.NORD],[ConditionType.NOT_HAS_STIPULATION]:["gear"]},
    "Use Imperial-style gear only": {[ConditionType.HAS_RACE]:[RacesType.IMPERIAL],[ConditionType.NOT_HAS_STIPULATION]:["gear"]},
    "Can only equip artifacts": {[ConditionType.NOT_HAS_STIPULATION]:["gear", "Can only use custom enchantments"]},
    "Cannot equip artifacts": {[ConditionType.NOT_HAS_STIPULATION]:["gear"]},
    ...
    "No Seyda Neen": {[ConditionType.NOT_HAS_OBJECTIVE]:["whilst remaining within"],[ConditionType.NOT_HAS_STIPULATION]:["Start in"]},
